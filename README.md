...
# "A quantum machine with qubits orientation cannot resolve an open knight tour (OKT) of lattice basis if and if the column (c) and the row (r) of the matix are repectively of r=>16 and c =>16 where a word could be equal or greater than 8 bytes."
