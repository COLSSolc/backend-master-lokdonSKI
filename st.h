...
// we have talked to remove this space char and add one more from Latin Extended
wchar_t NOBREAK				= L'\u00A0';
...
wchar_t LAT_CAP_L_STROKE                = L'\u0141';


/* MPIN specific border number for 16*16 Matrix */
int leftBorder[ROWS] = {0, 16, 32, 48, 64, 80, 96, 112, 128, 144, 160, 176, 192, 208, 224, 240};
int rightBorder[ROWS] =  {15, 31, 47, 63, 79, 95, 111, 127, 143, 159, 175, 191, 207, 223, 239, 255};
...
const wchar_t matrix[ROWS][COLS] = {
 ...
 wchar_t linearMatrix[ROWS*COLS] = 
	{SPACE, EXCLAIMATION, QUOTATION, NUMBER, DOLLAR, PERCENT, 
	AMPERSAND, APOSTRPOHE, LEFT_PAREN, RIGHT_PAREN, ASTERISK, 
	PLUS, COMMA, MINUS, FULLSTOP, SOLIDUS, ZERO, ONE, TWO, 
	THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, COLON, SEMICOLON, 
	LESSTHAN, EQUAL, GREATERTHAN, QUESTION, AT, CAPITAL_A, CAPITAL_B, 
	CAPITAL_C, CAPITAL_D, CAPITAL_E, CAPITAL_F, CAPITAL_G, CAPITAL_H,
	CAPITAL_I, CAPITAL_J, CAPITAL_K, CAPITAL_L, CAPITAL_M, CAPITAL_N,
	CAPITAL_O, CAPITAL_P, CAPITAL_Q, CAPITAL_R, CAPITAL_S, CAPITAL_T, 
	CAPITAL_U, CAPITAL_V, CAPITAL_W, CAPITAL_X, CAPITAL_Y, CAPITAL_Z,
	LEFTSQUARE, REVERSE_SOLIDIUS, RIGHTSQUARE, CIRCUMFLEX, UNDERSCORE,
	GRAVEACCENT, SMALL_A, SMALL_B, SMALL_C, SMALL_D, SMALL_E, SMALL_F, SMALL_G,
	...
	SMALL_X, SMALL_Y, SMALL_Z, LEFTCURLY, VERTICALLINE, RIGHTCURLY, TILDE,
	INV_EXCLAIM, CENTSIGN, POUND, CURRENCY, YEN, PIPE, SECTION, DIAERESIS, COPYRIGHT,
	FEMININE, LEFT_ANGLE, NOT_SIGN, SOFT_HYPHEN, REGISTERED, MACRON, DEGREE,
	PLUS_MINUS, SQUARE, CUBICAL, ACUTE_ACCENT, MICRO_SIGN, PILCROW, MIDDLE_DOT,
	CEDILA, SUPERSCRIPT_ONE, MASCULINE_ORDINAL_ONE, RIGHT_ANGLE, ONE_QUARTER, ONE_HALF,
	THREE_QUARTER, INVERTED_QUESTION, LAT_CAPITAL_A_GRAVE, LAT_CAPITAL_A_ACUTE, 
	LAT_CAPITAL_A_CIRCUM, LAT_CAPITAL_A_TILDE, LAT_CAPITAL_A_DIAERSIS, 
	LAT_CAPITAL_A_RING, LAT_CAPITAL_A_E, LAT_CAPITAL_C_CADILA, LAT_CAPITAL_E_GRAVE,
	LAT_CAPITAL_E_ACUTE, LAT_CAPITAL_E_CIRCUM, LAT_CAPITAL_E_DIAERSIS, 
	LAT_CAPITAL_I_GRAVE, LAT_CAPITAL_I_ACUTE, LAT_CAPITAL_I_CIRCUM, LAT_CAPITAL_I_DIAERSIS,
	LAT_CAPITAL_ETH, LAT_CAPITAL_N_TILDE, LAT_CAPITAL_O_GRAVE, LAT_CAPITAL_O_ACUTE,
	LAT_CAPITAL_O_CIRCUM, LAT_CAPITAL_O_TILDE, LAT_CAPITAL_O_DIAERSIS, MULTIPLCATION,
	LAT_CAPITAL_O_STROKE, LAT_CAPITAL_U_GRAVE, LAT_CAPITAL_U_ACUTE, LAT_CAPITAL_U_CIRCUM,
	LAT_CAPITAL_U_DIAERSIS, LAT_CAPITAL_Y_ACUTE, CAP_THORN, SHARP_S, LAT_SMALL_A_GRAVE,
	LAT_SMALL_A_ACUTE, LAT_SMALL_A_CIRCUM, LAT_SMALL_A_TILDE, LAT_SMALL_A_DIAERSIS,
	LAT_SMALL_A_RING, LAT_SMALL_A_AE, LAT_SMALL_C_CEDILA, LAT_SMALL_E_GRAVE, LAT_SMALL_E_ACUTE,
	LAT_SMALL_E_CIRCUM, LAT_SMALL_E_DIAERSIS, LAT_SMALL_I_GRAVE, LAT_SMALL_I_ACUTE, 
	LAT_SMALL_I_CIRCUM, LAT_SMALL_I_DIAERSIS, LAT_SMALL_ETH, LAT_SMALL_N_TILDE, LAT_SMALL_O_GRAVE,
	LAT_SMALL_O_ACUTE, LAT_SMALL_O_CIRCUM, LAT_SMALL_O_TILDE, LAT_SMALL_O_DIAERSIS, DIVISION,
	LAT_SMALL_O_STROKE, LAT_SMALL_U_GRAVE, LAT_SMALL_U_ACUTE, LAT_SMALL_U_CIRCUM, 
	LAT_SMALL_U_DIAERSIS, LAT_SMALL_Y_ACUTE, SMALL_THORN, LAT_SMALL_Y_DIAERSIS, LAT_CAP_A_MACRON,
	LAT_SMALL_A_MACRON, LAT_CAP_A_BREVE, LAT_SMALL_A_BREVE, LAT_CAP_A_OGONEK, LAT_SMALL_A_OGONEK, 
	LAT_CAP_C_ACUTE, LAT_SMALL_C_ACUTE, LAT_CAP_C_CIRCUM, LAT_SMALL_C_CIRCUM, LAT_CAP_C_DOT,
	LAT_SMALL_C_DOT, LAT_CAP_C_CARON, LAT_SMALL_C_CARON, LAT_CAP_D_CARON, LAT_SMALL_D_CARON,
	LAT_CAP_D_STROKE, LAT_SMALL_D_STROKE, LAT_CAP_E_MACRON, LAT_SMALL_E_MACRON, LAT_CAP_E_BREVE,
	LAT_SMALL_E_BREVE, LAT_CAP_E_DOT, LAT_SMALL_E_DOT, LAT_CAP_E_OGONEK, LAT_SMALL_E_OGONEK,
	LAT_CAP_E_CARON, LAT_SMALL_E_CARON, LAT_CAP_G_CIRCUM, LAT_SMALL_G_CIRCUM, LAT_CAP_G_BREVE,
	LAT_SMALL_G_BREVE, LAT_CAP_G_DOT, LAT_SMALL_G_DOT, LAT_CAP_G_CEDILA, LAT_SMALL_G_CEDILA, 
	LAT_CAP_H_CIRCUM, LAT_SMALL_H_CIRCUM, LAT_CAP_H_STROKE, LAT_SMALL_H_STROKE, LAT_CAP_I_TILDE,
	LAT_SMALL_I_TILDE, LAT_CAP_I_MACRON, LAT_SMALL_I_MACRON, LAT_CAP_I_BREVE, LAT_SMALL_I_BREVE,
	LAT_CAP_I_OGONEK, LAT_SMALL_I_OGONEK, LAT_CAP_I_DOT, LAT_SMALL_I_DOTLESS, LAT_CAP_LIGATURE,
	LAT_SMALL_LIGATURE, LAT_CAP_J_CIRCUM, LAT_SMALL_J_CIRCUM, LAT_CAP_K_CEDILA, LAT_SMALL_K_CEDILA,
	LAT_SMALL_KRA, LAT_CAP_L_ACUTE, LAT_SMALL_L_ACUTE, LAT_CAP_L_CEDILA, LAT_SMALL_L_CEDILA,
	LAT_CAP_L_CARON, LAT_SMALL_L_CARON, LAT_CAP_L_MIDDOT, LAT_SMALL_L_MIDDOT, LAT_CAP_L_STROKE};
